(() => {
    ...
    (() => {
        ...
        if (document.querySelector(".crypto-news__slider")) new core(".crypto-news__slider", {
            modules: [ Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: 4,
        ...
        if (document.querySelector(".brands-detailed-project__slider")) new core(".brands-detailed-project__slider", {
            modules: [ Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: "auto",
        ...
        if (document.querySelector(".teams-detailed-project__slider")) new core(".teams-detailed-project__slider", {
            modules: [ Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: 3,
        ...
        if (document.querySelector(".participate-detailed-project__slider")) new core(".participate-detailed-project__slider", {
            modules: [ Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: "auto",
        ...
        if (myVideo) myVideo.addEventListener("click", (function() {
            if (myVideo.paused) {
                myVideo.play();
        ...
        if (arc) arc.style.strokeDasharray = 25 * Math.PI * .5 + " 100";
